    ...
    <section className="py-20 luxury-gradient-bg relative">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            Comprehensive Real Estate Solutions — At HSquare Promoters, we provide end-to-end real estate services designed to help individuals, families, and investors make confident property decisions.
          </motion.p>
        </div>
      </div>
    </section>
